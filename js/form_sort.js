...
function showActionFormSortItems() {
    ...
    htmlContainer.addEventListener('submit', hideActionFormAfterSorting); /* wait for the form submit */
...
function sortItems(key, attribute) {
    ...
    STORAGE.list = sort.sortItemsByKey(sourceArray, key, attribute); /* update the global array */
