...
function showActionFormBuyItem(sourceArrayIndex) {
    ...
    htmlContainer.innerHTML = `
      <div class="action-form">
        <div class="buy-item">
          <h1>Do you really want to buy ${sourceArray[sourceArrayIndex].quantity} unit(s) of ${
        sourceArray[sourceArrayIndex].product
    } at the price of ${sourceArray[sourceArrayIndex].price.toLocaleString('en-US', {
        style: 'currency',
        currency: 'USD',
    })} ?</h1>
...
function buyItem(sourceArray, sourceArrayIndex) {
    const updatedList = change.addItemToListAfterBuying(sourceArray, sourceArrayIndex);
